...
@JsonDeserialize(builder = PostSettlementReconRequest.Builder.class)
public final class PostSettlementReconRequest {
  ...
  PostSettlementReconRequest(Optional<String> accept, FetchSettlementReconRequest body) {
    this.accept = accept;
    this.body = body;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PostSettlementReconRequest
        && equalTo((PostSettlementReconRequest) other);
  }

  private boolean equalTo(PostSettlementReconRequest other) {
  ...
  public String toString() {
    return "PostSettlementReconRequest{" + "accept: " + accept + ", body: " + body + "}";
  }
  ...
  public interface BodyStage {
    ...
    Builder from(PostSettlementReconRequest other);
  }

  public interface _FinalStage {
    PostSettlementReconRequest build();
  ...
  public static final class Builder implements BodyStage, _FinalStage {
    ...
    @Override
    public Builder from(PostSettlementReconRequest other) {
    ...
    @Override
    public PostSettlementReconRequest build() {
      return new PostSettlementReconRequest(accept, body);
    }
  }
}
