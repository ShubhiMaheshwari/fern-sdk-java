...
public final class AuthenticationError {
  ...
  AuthenticationError(Optional<String> message, Optional<String> code, Optional<String> type) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof AuthenticationError && equalTo((AuthenticationError) other);
  }

  private boolean equalTo(AuthenticationError other) {
  ...
  public static final class Builder {
    ...
    public Builder from(AuthenticationError other) {
