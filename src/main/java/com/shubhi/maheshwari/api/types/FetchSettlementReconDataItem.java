...
@JsonDeserialize(builder = FetchSettlementReconDataItem.Builder.class)
public final class FetchSettlementReconDataItem {
  ...
  /**
   * @return The event type can be PAYMENT, REFUND, REFUND_REVERSAL, DISPUTE, DISPUTE_REVERSAL,
   *     CHARGEBACK, CHARGEBACK_REVERSAL, OTHER_ADJUSTMENT.
   */
  ...
  /**
   * @return Amount corresponding to the event. Example, refund amount, dispute amount, payment
   *     amount, etc.
   */
  ...
  /**
   * @return Specifies whether the dispute was closed in favor of the merchant or customer. Possible
  ...
  /**
   * @return An unique ID associated with the refund.
   */
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FetchSettlementReconDataItem
        && equalTo((FetchSettlementReconDataItem) other);
  }

  private boolean equalTo(FetchSettlementReconDataItem other) {
  ...
  public String toString() {
    return "FetchSettlementReconDataItem{"
        + "eventId: "
        + eventId
        + ", eventType: "
        + eventType
  ...
  public static final class Builder {
    ...
    public Builder from(FetchSettlementReconDataItem other) {
    ...
    public FetchSettlementReconDataItem build() {
      return new FetchSettlementReconDataItem(
          eventId,
          eventType,
          eventSettlementAmount,
          eventAmount,
